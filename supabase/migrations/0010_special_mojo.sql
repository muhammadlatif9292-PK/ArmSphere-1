...
ALTER TABLE "events" ADD COLUMN IF NOT EXISTS "organizer_id" uuid;--> statement-breakpoint
ALTER TABLE "events" ADD COLUMN IF NOT EXISTS "payment_method" varchar(50) DEFAULT 'STRIPE' NOT NULL;--> statement-breakpoint
